...
public class LocationUtil {
    ...
    public static boolean hasPersistentData(Location location) {
        return location.getChunk().getPersistentDataContainer().has(new NamespacedKey(APIByLogic.getInstance(), locationToString(location, "._.")), PersistentDataType.TAG_CONTAINER);
    }

    public static PersistentDataContainer getPersistentData(Location location, boolean create) {
        NamespacedKey locationKey = new NamespacedKey(APIByLogic.getInstance(), locationToString(location, "._."));
    ...
    public static void savePersistentData(Location location, PersistentDataContainer container) {
        location.getChunk().getPersistentDataContainer().set(new NamespacedKey(APIByLogic.getInstance(), locationToString(location, "._.")), PersistentDataType.TAG_CONTAINER, container);
    }
