...
public class ModulesCommand extends ModuleCommand {
    ...
    private void displayPage(CommandSender sender, int page) {
        ...
        for (int i = startingModule; i < lastModule; i++) {
            ...
            moduleComponent.setClickEvent(new ClickEvent(ClickEvent.Action.RUN_COMMAND, module.isEnabled() ? "/module disable " + module.getModuleData().getId() : "/module enable " + module.getModuleData().getId()));
