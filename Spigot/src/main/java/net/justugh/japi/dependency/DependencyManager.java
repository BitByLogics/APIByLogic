package net.justugh.japi.dependency;

import lombok.Getter;
import net.justugh.japi.JustAPIPlugin;
import net.justugh.japi.dependency.annotation.Dependency;
import net.justugh.japi.util.Table;
...
public class DependencyManager {
    ...
    public DependencyManager() {
        ...
        registerDependency(JustAPIPlugin.class, JustAPIPlugin.getInstance());
    ...
    public void injectDependencies(Object obj) {
        ...
        do {
            for (Field field : clazz.getDeclaredFields()) {
                ...
                if (object == null) {
                    JustAPIPlugin.getInstance().getLogger().log(Level.SEVERE,
