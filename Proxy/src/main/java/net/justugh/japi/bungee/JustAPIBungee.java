package net.justugh.japi.bungee;
...
@Getter
public class JustAPIBungee extends Plugin {

    @Getter
    private static JustAPIBungee instance;
    ...
    public void onEnable() {
        ...
        JustAPIProxy.initialize(redisManager, ProxyType.BUNGEECORD);
    }
